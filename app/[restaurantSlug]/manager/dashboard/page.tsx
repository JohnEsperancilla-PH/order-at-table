...
import { DashboardClient } from '@/app/[restaurantSlug]/cashier/dashboard/dashboard-client'
...
export default async function ManagerDashboardPage({
  ...
  const [orders, menuItems, tables] = await Promise.all([
    ...
    getMenuItemsByRestaurantSlug(restaurantSlug, false),
  ...
  return (
    <DashboardClient
      restaurant={{ id: restaurant.id, name: restaurant.name, slug: restaurantSlug, is_open: restaurant.is_open }}
      counts={counts}
